...
import { Play, Pause, Upload, TrendingUp, TrendingDown, Minus, Calendar, Grid, Gauge, LayoutGrid, Award, Crown, ArrowUpRight, ArrowDownRight, Target, Zap, BarChart2, Clock, Link, FileText, X, ChevronDown, RefreshCw, Globe } from 'lucide-react';
...
const AnalyticsView = ({ data, t }: { data: ParsedData, t: Record<string, string> }) => {
